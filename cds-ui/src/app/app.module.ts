...
import { CBAWizardComponent, HeaderComponent, AboutComponent, PageNotFoundComponent } from './common/components/index';
// import { SelectTemplateModule, ModifyTemplateModule, TestTemplateModule, DeployTemplateModule} from './feature-module/index';
...
@NgModule({ 
  ...
  imports: [
    ...
    // ModifyTemplateModule, TestTemplateModule, DeployTemplateModule
  ],
  providers: [],
