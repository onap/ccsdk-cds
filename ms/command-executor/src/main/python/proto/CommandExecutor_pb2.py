...
_EXECUTIONINPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resolvedTemplateData', full_name='org.onap.ccsdk.cds.controllerblueprints.command.api.ExecutionInput.resolvedTemplateData', index=9,
...
_RESOLVEDTEMPLATEDATA = _descriptor.Descriptor(
  name='ResolvedTemplateData',
  full_name='org.onap.ccsdk.cds.controllerblueprints.command.api.ResolvedTemplateData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resolutionKey', full_name='org.onap.ccsdk.cds.controllerblueprints.command.api.ResolvedTemplateData.resolutionKey', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='artifactName', full_name='org.onap.ccsdk.cds.controllerblueprints.command.api.ResolvedTemplateData.artifactName', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result', full_name='org.onap.ccsdk.cds.controllerblueprints.command.api.ResolvedTemplateData.result', index=2,
...
_EXECUTIONINPUT.fields_by_name['resolvedTemplateData'].message_type = _RESOLVEDTEMPLATEDATA
...
DESCRIPTOR.message_types_by_name['ResolvedTemplateData'] = _RESOLVEDTEMPLATEDATA
...
ResolvedTemplateData = _reflection.GeneratedProtocolMessageType('ResolvedTemplateData', (_message.Message,), {
  'DESCRIPTOR' : _RESOLVEDTEMPLATEDATA,
  '__module__' : 'CommandExecutor_pb2'
  # @@protoc_insertion_point(class_scope:org.onap.ccsdk.cds.controllerblueprints.command.api.ResolvedTemplateData)
})
_sym_db.RegisterMessage(ResolvedTemplateData)

UploadBlueprintInput = _reflection.GeneratedProtocolMessageType('UploadBlueprintInput', (_message.Message,), {
...
UploadBlueprintOutput = _reflection.GeneratedProtocolMessageType('UploadBlueprintOutput', (_message.Message,), {
