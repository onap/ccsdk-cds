...
open class BluePrintScriptEvaluator(private val compiledCacheKey: String, private val scriptClassName: String)
    : ScriptEvaluator {
    ...
    override suspend operator fun invoke(compiledScript: CompiledScript<*>,
            ...
            try {
                ...
                bluePrintCompiledScript.compiledCacheKey = compiledCacheKey
