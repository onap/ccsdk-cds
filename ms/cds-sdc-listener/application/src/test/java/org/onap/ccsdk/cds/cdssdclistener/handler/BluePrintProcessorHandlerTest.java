...
@EnableConfigurationProperties(BluePrintProcesssorHandler.class)
...
public class BluePrintProcessorHandlerTest {
    ...
    private static final String CBAR_ARCHIVE = "src/test/resources/testcba.zip";
    ...
    public void testApplicationEndPointSucess() throws IOException {
        ...
        assertEquals(SUCCESS_MSG, output.getMessage());
    }

    private BluePrintUploadInput generateRequest() throws IOException {
        File file = Paths.get(CBAR_ARCHIVE).toFile();
