...
import org.onap.ccsdk.cds.blueprintsprocessor.services.execution.StreamingRemoteExecutionServiceImpl
...
class StreamingRemoteExecutionServiceTest {
    ...
    fun testStreamingChannel() {
        grpcCleanup.register(serverBuilder.addService(MockBluePrintProcessingGRPCServer()).build().start())
