...
import org.onap.ccsdk.cds.controllerblueprints.core.ErrorCatalogDomainsConstants.BLUEPRINT_PROCESSOR
...
import org.onap.ccsdk.error.catalog.getErrorType
...
class ErrorCatalogManagerImplTest {
    ...
    fun setup() {
        ...
        enumError = EnumErrorCatalogCodes.GENERIC_FAILURE.getErrorType(BLUEPRINT_PROCESSOR)
    ...
    fun generateExceptionFromEnumErrorWithHttpCode() {
        val errorCatalogException = errorCatalogManagerImpl.generateException(enumErrorCatalog = enumError,
                protocol = ERROR_CATALOG_PROTOCOL_HTTP, message = "Generated exception from Enum error catalog")
    ...
    fun generateExceptionFromEnumErrorWithGrpcCode() {
        val errorCatalogException = errorCatalogManagerImpl.generateException(enumErrorCatalog = enumError,
                message = "Generated exception from Enum error catalog")
