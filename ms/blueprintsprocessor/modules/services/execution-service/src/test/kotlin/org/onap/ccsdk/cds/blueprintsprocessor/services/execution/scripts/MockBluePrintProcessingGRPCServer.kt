...
private val log = logger(MockBluePrintProcessingGRPCServer::class)


class MockBluePrintProcessingGRPCServer : BluePrintProcessingServiceCoroutineGrpc.BluePrintProcessingServiceImplBase() {
    ...
    runBlocking {
        try {
            val server = ServerBuilder
                    .forPort(50052)
                    .addService(MockBluePrintProcessingGRPCServer())
                    .build()
            server.start()
