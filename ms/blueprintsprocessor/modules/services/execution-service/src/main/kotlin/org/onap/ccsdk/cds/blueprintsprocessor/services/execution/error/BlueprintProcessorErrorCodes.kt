 ...
 * @version 1.0
 */
enum class BlueprintProcessorErrorCodes(val domain: String = ErrorCodeDomainsConstants.BLUEPRINT_PROCESSOR): EnumErrorCatalogInterface {
    ...
    INVALID_FILE_EXTENSION(ErrorCodeDomainsConstants.SELFSERVICE_API) {
        override fun getErrorModel(): ErrorModel {
            return findErrorModel()
        }
    };
    ...
    companion object {
        ...
        @Autowired
        lateinit var errorCatalogServiceImpl: ErrorCatalogServiceImpl
