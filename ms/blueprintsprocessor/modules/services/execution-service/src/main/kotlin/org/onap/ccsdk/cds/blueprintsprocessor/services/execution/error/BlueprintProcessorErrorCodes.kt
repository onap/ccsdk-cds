...
enum class BlueprintProcessorErrorCodes(
    ...
    GENERIC_FAILURE(httpCode = 500, grpcCode = 2) {
        override fun getErrorCatalog(): ErrorCatalog {
    ...
    protected fun findErrorModel(): ErrorCatalog {
        return errorCatalogServiceImpl.getErrorCatalog(name, domain)
                ?: GENERIC_FAILURE.getErrorCatalog()
    }
}
