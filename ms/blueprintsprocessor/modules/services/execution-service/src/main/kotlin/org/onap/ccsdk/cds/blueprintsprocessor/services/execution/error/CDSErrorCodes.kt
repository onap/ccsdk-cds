...
enum class CDSErrorCodes(
    var domain: String = ErrorCatalogDomainsConstants.BLUEPRINT_PROCESSOR,
    var httpCode: Int,
    var grpcCode: Int
) : EnumErrorCatalogInterface {

    INTERNAL_ERROR(httpCode = 500, grpcCode = 2) {
    ...
    ENRICH_FAILURE(httpCode = 500, grpcCode = 2) {
        override fun getErrorName(): String { return name }
        override fun getErrorDomain(): String { return domain }
        override fun getErrorHttpCode(): Int { return httpCode }
        override fun getErrorGrpcCode(): Int { return grpcCode }
    ...
    companion object {
        private val map = HashMap<String, CDSErrorCodes>()
        private const val DEFAULT_ERROR_ID = "INTERNAL_ERROR"

        init {
            for (enumErrorCode in CDSErrorCodes.values()) {
                map[enumErrorCode.name] = enumErrorCode
            }
        }

        fun valueOf(value: String): CDSErrorCodes {
