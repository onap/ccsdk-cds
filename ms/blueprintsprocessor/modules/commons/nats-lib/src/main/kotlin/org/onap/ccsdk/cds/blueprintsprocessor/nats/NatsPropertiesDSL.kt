...
fun TopologyTemplateBuilder.natsRelationshipTemplate(
    name: String,
    description: String,
...
class NatsRelationshipTemplateBuilder(name: String, description: String) :
    ...
    fun tokenAuth(block: NatsTokenAuthPropertiesAssignmentBuilder.() -> Unit) {
        property(BluePrintConstants.PROPERTY_CONNECTION_CONFIG, BluePrintTypes.tokenAuth(block))
    }

    fun tlsAuth(block: NatsTLSAuthPropertiesAssignmentBuilder.() -> Unit) {
        property(BluePrintConstants.PROPERTY_CONNECTION_CONFIG, BluePrintTypes.tlsAuth(block))
    }
}

fun BluePrintTypes.tokenAuth(block: NatsTokenAuthPropertiesAssignmentBuilder.() -> Unit): JsonNode {
...
fun BluePrintTypes.tlsAuth(block: NatsTLSAuthPropertiesAssignmentBuilder.() -> Unit): JsonNode {
