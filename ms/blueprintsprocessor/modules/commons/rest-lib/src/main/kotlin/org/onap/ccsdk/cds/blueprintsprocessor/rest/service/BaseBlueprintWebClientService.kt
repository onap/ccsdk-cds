...
abstract class BaseBlueprintWebClientService<out E : RestClientProperties> : BlueprintWebClientService {
    ...
    private fun performHttpCall(httpUriRequest: HttpUriRequest): WebClientResponse<String> {
    ...
    override fun uploadBinaryFile(path: String, filePath: Path): WebClientResponse<String> {
