...
class ExecutionServiceHandlerTest {
    ...
    fun testPublishAuditFunction() {
        ...
        coEvery { publishAuditService.publish(any(), ExecutionServiceInput(), any()) } just Runs
        ...
        coVerify {
            publishAuditService.publish(any(), executionServiceInput)
        }

        verify {
            publishAuditService.publish(any(), executionServiceOutput!!)
        }
    }
}
