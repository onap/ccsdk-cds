...
class NetconfSessionImpl(private val deviceInfo: DeviceInfo, private val rpcService: NetconfRpcService):NetconfSession {
    override fun checkAndReestablish() {
    }

    private val sshClientWrapper = NetconfSshClientWrapper()
