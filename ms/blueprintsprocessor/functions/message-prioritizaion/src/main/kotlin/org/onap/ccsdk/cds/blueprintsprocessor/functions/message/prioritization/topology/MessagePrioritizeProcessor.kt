...
open class MessagePrioritizeProcessor(private val messagePrioritizationService: MessagePrioritizationService)
    : AbstractBluePrintMessageProcessor<ByteArray, ByteArray>() {
    ...
    override suspend fun processNB(key: ByteArray, value: ByteArray) {
        ...
        // Save the Message
        messagePrioritizationService.saveMessage(data)
    ...
    override fun init(context: ProcessorContext) {
        ...
        log.info("initializing prioritization processor applicationId(${processorContext.applicationId()}), " +
                "taskId(${context.taskId()})")

        val expiryPunctuator = MessagePriorityExpiryPunctuator(messagePrioritizationService)
        ...
        val cleanPunctuator = MessagePriorityCleanPunctuator(messagePrioritizationService)
