...
@Service
open class MessagePrioritizationServiceImpl(
        private val prioritizationMessageRepository: PrioritizationMessageRepository) : MessagePrioritizationService {

    private val log = logger(MessagePrioritizationServiceImpl::class)
