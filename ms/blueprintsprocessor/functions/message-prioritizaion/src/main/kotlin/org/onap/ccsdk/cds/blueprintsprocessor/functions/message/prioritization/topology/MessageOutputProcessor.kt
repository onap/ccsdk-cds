...
open class MessageOutputProcessor : AbstractMessagePrioritizeProcessor<String, MessagePrioritization>() {

    private val log = logger(MessageOutputProcessor::class)

    override suspend fun processNB(key: String, value: MessagePrioritization) {
        messagePrioritizationStateService.updateMessageState(value.id, MessageState.EXPIRED.name)
