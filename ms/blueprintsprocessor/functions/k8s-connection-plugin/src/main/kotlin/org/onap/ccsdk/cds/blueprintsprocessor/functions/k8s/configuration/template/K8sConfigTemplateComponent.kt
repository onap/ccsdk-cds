...
open class K8sConfigTemplateComponent(
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        for (prefix in prefixList) {
            ...
            val api = K8sPluginApi(
                k8sConnectionPluginConfiguration.getProperties().username,
                k8sConnectionPluginConfiguration.getProperties().password,
                k8sConnectionPluginConfiguration.getProperties().url
            )
