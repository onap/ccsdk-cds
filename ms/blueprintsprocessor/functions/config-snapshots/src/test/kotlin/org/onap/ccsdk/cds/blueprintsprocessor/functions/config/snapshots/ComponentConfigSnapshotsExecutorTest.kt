...
class ComponentConfigSnapshotsExecutorTest {
    ...
    fun processNBFetchWithResourceIdAndResourceTypeSingleFind() {
        ...
        runBlocking {
            ...
            assertEquals(ComponentConfigSnapshotsExecutor.RESPONSE_STATUS_SUCCESS.asJsonPrimitive(),
                    bluePrintRuntimeService.getNodeTemplateAttributeValue(nodeTemplateName,
                            ComponentConfigSnapshotsExecutor.RESPONSE_STATUS))
            assertEquals(snapshotConfig.asJsonPrimitive(),
                    bluePrintRuntimeService.getNodeTemplateAttributeValue(nodeTemplateName,
                            ComponentConfigSnapshotsExecutor.RESPONSE_SNAPSHOT))
        }
    }
    ...
    fun processNBFetchNoneFound() {
        ...
        runBlocking {
            ...
            assertEquals(ComponentConfigSnapshotsExecutor.RESPONSE_STATUS_ERROR.asJsonPrimitive(),
                    bluePrintRuntimeService.getNodeTemplateAttributeValue(nodeTemplateName,
                            ComponentConfigSnapshotsExecutor.RESPONSE_STATUS))
        }
    }
    ...
    fun processNBErrorOperationUnknown() {
        ...
        runBlocking {
            ...
            assertEquals(msg.asJsonPrimitive(),
                    bluePrintRuntimeService.getNodeTemplateAttributeValue(nodeTemplateName,
                            ComponentConfigSnapshotsExecutor.RESPONSE_MESSAGE))
        }
    }
