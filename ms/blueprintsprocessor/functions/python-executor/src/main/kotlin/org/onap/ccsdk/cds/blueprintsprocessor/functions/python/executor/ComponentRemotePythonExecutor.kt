...
open class ComponentRemotePythonExecutor(private val remoteScriptExecutionService: RemoteScriptExecutionService)
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        setAttribute(ATTRIBUTE_PREPARE_ENV_LOG, prepareEnvMsg.asJsonPrimitive())
        log.info("$ATTRIBUTE_PREPARE_ENV_LOG - $prepareEnvMsg")
        setAttribute(ATTRIBUTE_EXEC_CMD_LOG, executeCommandMsg.asJsonPrimitive())
        log.info("$ATTRIBUTE_PREPARE_ENV_LOG - $executeCommandMsg")
