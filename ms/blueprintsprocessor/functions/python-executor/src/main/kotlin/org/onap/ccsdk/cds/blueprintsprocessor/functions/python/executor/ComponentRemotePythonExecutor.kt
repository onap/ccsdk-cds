...
open class ComponentRemotePythonExecutor(private val remoteScriptExecutionService: RemoteScriptExecutionService)
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        val argumentProperties = getOptionalOperationInput(INPUT_ARGUMENT_PROPERTIES)
        ...
        try {
            ...
            // Populate Script Argument Information and pass it to the remote server
            val properties = argumentProperties?.rootFieldsToMap() ?: hashMapOf()
