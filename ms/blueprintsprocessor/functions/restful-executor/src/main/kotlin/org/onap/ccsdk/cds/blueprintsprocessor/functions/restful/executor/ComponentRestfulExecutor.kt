...
open class ComponentRestfulExecutor(private var applicationContext: ApplicationContext, private val blueprintJythonService: BlueprintJythonServiceImpl) : AbstractComponentFunction() {

    private val log = LoggerFactory.getLogger(ComponentRestfulExecutor::class.java)

    private lateinit var componentFunction: RestfulCMComponentFunction

    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        log.info("Processing : $operationInputs")
        // Populate Component Instance
        populateRestfulComponentInstance()
    ...
    private suspend fun populateRestfulComponentInstance() {
        ...
        val RestDependencies: MutableList<String> = arrayListOf()
        RestDependencies.add(RestLibConstants.SERVICE_BLUEPRINT_REST_LIB_PROPERTY)
        ...
        RestDependencies.forEach { RestDependency ->
            componentFunction.functionDependencyInstances[RestDependency] = applicationContext.getBean(RestDependency)
        }
    }
}
