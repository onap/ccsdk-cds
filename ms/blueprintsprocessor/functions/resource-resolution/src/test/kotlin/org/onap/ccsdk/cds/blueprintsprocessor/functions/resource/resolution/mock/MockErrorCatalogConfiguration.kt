...
import org.onap.ccsdk.cds.blueprintsprocessor.services.execution.error.ErrorCatalogServiceImpl
...
open class MockErrorCatalogConfiguration {
    ...
    @Bean
    open fun errorCatalogService(): ErrorCatalogServiceImpl {
        ...
        return ErrorCatalogServiceImpl(ErrorMessagesLibPropertyService(errorCatalogProperties))
    }
}
