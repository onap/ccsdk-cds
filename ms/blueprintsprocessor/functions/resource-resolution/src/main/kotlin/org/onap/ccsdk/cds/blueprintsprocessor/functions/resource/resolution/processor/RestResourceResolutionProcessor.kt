        ...
        try {
            ...
            if (!setFromInput(resourceAssignment)) {
                ...
                if (responseStatusCode in 200..299 && outputKeyMapping == null) {
                    // it means we ignore the value and we set its value null but status is fine
                    // ResourceAssignmentUtils.setResourceDataValue(resourceAssignment, raRuntimeService, "".asJsonPrimitive())
