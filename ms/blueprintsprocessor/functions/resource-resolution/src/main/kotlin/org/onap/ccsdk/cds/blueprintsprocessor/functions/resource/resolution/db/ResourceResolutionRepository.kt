...
interface ResourceResolutionRepository : JpaRepository<ResourceResolution, String> {
    ...
    @Query(value = "SELECT * FROM RESOURCE_RESOLUTION WHERE resolution_key = :key AND blueprint_name = :blueprintName AND blueprint_version = :blueprintVersion AND artifact_name = :artifactName AND occurrence <=  :firstN",
            nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM RESOURCE_RESOLUTION WHERE resolution_key = :key AND blueprint_name = :blueprintName AND blueprint_version = :blueprintVersion AND artifact_name = :artifactName AND" +
    ...
    @Query(value = "SELECT * FROM RESOURCE_RESOLUTION WHERE resolution_key = :key AND blueprint_name = :blueprintName AND blueprint_version = :blueprintVersion AND artifact_name = :artifactName AND occurrence BETWEEN :begin AND :end ORDER BY occurrence DESC, creation_date DESC",
            nativeQuery = true)
