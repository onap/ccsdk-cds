...
open class DatabaseResourceAssignmentProcessor(private val bluePrintDBLibPropertySevice: BluePrintDBLibPropertySevice,
    ...
    private fun validate(resourceAssignment: ResourceAssignment) {
        ...
        {
            "resource assignment source is not ${ResourceDictionaryConstants.SOURCE_DB} but it is ${resourceAssignment.dictionarySource}"
        }
    }

    //placeholder to get the list of DB sources.
    //TODO: This will be replaced with a DB
    private fun getListOfDBSources(): Array<String> =  arrayOf(ResourceDictionaryConstants.SOURCE_DB)
