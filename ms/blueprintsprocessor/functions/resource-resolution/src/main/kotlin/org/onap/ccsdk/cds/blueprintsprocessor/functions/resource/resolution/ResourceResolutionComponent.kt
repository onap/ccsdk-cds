...
open class ResourceResolutionComponent(private val resourceResolutionService: ResourceResolutionService) :
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        val resolutionKey =
            getOptionalOperationInput(ResourceResolutionConstants.RESOURCE_RESOLUTION_INPUT_KEY)?.asText() ?: ""
        val storeResult =
            getOptionalOperationInput(ResourceResolutionConstants.RESOURCE_RESOLUTION_INPUT_STORE_RESULT)?.asBoolean()
                ?: false
        val resourceId =
            getOptionalOperationInput(ResourceResolutionConstants.RESOURCE_RESOLUTION_INPUT_RESOURCE_ID)?.asText() ?: ""
        val resourceType =
            getOptionalOperationInput(ResourceResolutionConstants.RESOURCE_RESOLUTION_INPUT_RESOURCE_TYPE)?.asText()
                ?: ""
