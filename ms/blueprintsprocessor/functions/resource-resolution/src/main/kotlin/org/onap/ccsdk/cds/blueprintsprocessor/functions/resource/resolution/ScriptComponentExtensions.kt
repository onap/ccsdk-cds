...
/**
 * Return resolved and mashed artifact content for artifact mapping [artifactMapping]
 * and artifact template [artifactTemplate]
 */
suspend fun AbstractComponentFunction.contentFromResolvedArtifactNB(artifactMapping: String,
                                                                    artifactTemplate: String): String {
    return BluePrintDependencyService.resourceResolutionService()
            .resolveResources(bluePrintRuntimeService, nodeTemplateName, artifactMapping, artifactTemplate)
}
...
fun AbstractComponentFunction.contentFromResolvedArtifact(artifactMapping: String, artifactTemplate: String)
        : String = runBlocking {
    contentFromResolvedArtifactNB(artifactMapping, artifactTemplate)
}
