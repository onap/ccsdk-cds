 ...
 *      CLUSTER_DISCOVERY: AWS or AZURE or GCP or DOCKER_COMPOSE
...
open class BluePrintProcessorCluster(private val bluePrintClusterService: BluePrintClusterService) {
    ...
    fun startAndJoinCluster() = runBlocking {
        ...
        if (BluePrintConstants.CLUSTER_ENABLED) {
            ...
            val discoveryPlatform = System.getenv(BluePrintConstants.PROPERTY_CLUSTER_DISCOVERY)
                ?: throw BluePrintProcessorException("couldn't get environment variable ${BluePrintConstants.PROPERTY_CLUSTER_DISCOVERY}")
            ...
            val clusterInfo = ClusterInfo(
                ...
                discoverPlatform = DiscoveryPlatform.valueOf(discoveryPlatform.toUpperCase()),
