    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        try {
            ...
            when (actionName) {
                ...
                Action.DOWNLOAD_NE_SW.action -> processDownloadNeSw(client, deviceId, targetSwVersion, Action.DOWNLOAD_NE_SW)
        ...
        if (checkIfSwReadyToActivate(client, deviceId, targetSwVersion)) {
            ...
            val configCheckExecutionBlock: suspend (Int) -> String = { tryCount: Int ->
                ...
                if (result.body.contains("ACTIVATION_COMPLETED")) {
                    log.info("Activation is complete")
                    result.body
                } else {
