...
package org.onap.ccsdk.cds.blueprintsprocessor.uat.pnfconfig.aai.scripts
...
class RestconfConfigDeploy : AbstractScriptComponentFunction() {
    val CONFIGLET_TEMPLATE_NAME = "config-assign"
    private final val CONFIGLET_RESOURCE_PATH = "yang-ext:mount/mynetconf:netconflist"
    private final val RESTCONF_SERVER_IDENTIFIER = "sdnc"
    ...
    override suspend fun processNB(executionRequest: ExecutionServiceInput) {
        ...
        try {
            ...
            val deviceID:String = executionRequest.payload.get("config-deploy-request").get("config-deploy-properties").get("pnf-id").textValue()
            ...
            try {
                ...
                val currentConfig:Any = restconfDeviceConfig(webclientService, deviceID.toString(), CONFIGLET_RESOURCE_PATH)
