...
class ErrorPayload {
    ...
    constructor(code: Int = ERROR_CATALOG_DEFAULT_ERROR_CODE, status: String, errorMessage: String,
    ...
    constructor(code: Int = ERROR_CATALOG_DEFAULT_ERROR_CODE, status: String, errorMessage: String,
                logLevel: String = LogLevel.ERROR.name, debugMessage: String = "", message: ErrorMessage) {
        this.code = code
        this.status = status
        this.message = errorMessage
        this.logLevel = logLevel
