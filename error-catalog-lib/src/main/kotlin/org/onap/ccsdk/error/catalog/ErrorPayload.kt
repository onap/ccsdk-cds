...
class ErrorPayload {
    ...
    constructor(
        code: Int = ERROR_CATALOG_DEFAULT_ERROR_CODE, status: String, message: String,
    ...
    constructor(
        code: Int = ERROR_CATALOG_DEFAULT_ERROR_CODE, status: String, message: String,
        logLevel: String = LogLevel.ERROR.name, debugMessage: String = "", errorMessage: ErrorMessage
    ) {
        this.code = code
        this.status = status
        this.message = message
    ...
    fun isEqualTo(errorPayload: ErrorPayload): Boolean {
        return (this.code == errorPayload.code
                && this.status == errorPayload.status
                && this.message == errorPayload.message
                && this.logLevel == errorPayload.logLevel
                && this.debugMessage == errorPayload.debugMessage
