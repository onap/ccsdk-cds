...
abstract class ErrorCatalogManager(private val errorCatalogService: ErrorCatalogService) {
    ...
    abstract fun generateException(
            errorCatalog: ErrorCatalog, errorMessage: String, errorCause: Throwable, logLevel: String = LogLevel.ERROR.name
    ): ErrorCatalogException

    abstract fun generateException(
            errorCatalog: ErrorCatalog, errorMessage: String, errorCause: Throwable, logLevel: String = LogLevel.ERROR.name, vararg args: Any?
    ): ErrorCatalogException
    ...
    fun generateException(
        ...
        return generateException(errorCatalog, errorMessage, logLevel)
    }

    fun generateException(
            enumErrorCatalog: EnumErrorCatalogInterface, protocol: String, code: Int?, errorMessage: String,
            logLevel: String = LogLevel.ERROR.name
    ): ErrorCatalogException {
    ...
    fun generateException(
        ...
        val errorCatalog = getErrorCatalog(enumErrorCatalog, protocol, errorMessage)
        return generateException(errorCatalog, errorMessage, logLevel, args)
    }
    ...
    fun generateException(
            enumErrorCatalog: EnumErrorCatalogInterface, protocol: String, errorMessage: String, errorCause: Throwable,
            logLevel: String = LogLevel.ERROR.name
    ): ErrorCatalogException {
        val errorCatalog = getErrorCatalog(enumErrorCatalog, protocol, errorMessage, errorCause)
        return generateException(errorCatalog, errorMessage, errorCause, logLevel)
    }

    fun generateException(
            enumErrorCatalog: EnumErrorCatalogInterface, protocol: String, code: Int?, errorMessage: String, errorCause: Throwable,
            logLevel: String = LogLevel.ERROR.name
    ): ErrorCatalogException {
    ...
    fun generateException(
        ...
        val errorCatalog = getErrorCatalog(enumErrorCatalog, protocol, errorMessage, errorCause)
        return generateException(errorCatalog, errorMessage, errorCause, logLevel, args)
    }
